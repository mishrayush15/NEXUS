        ...
        <div className="container mx-auto px-6 py-5 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-3xl font-extrabold tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-gold via-amber-400 to-gold">
                  Create Buddy
                </span>
              ...
              {activeSection === "personality" && (
                <div className="space-y-8 animate-fade-slide-up">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="group">
                      <label className="block text-gold font-medium mb-3 text-lg group-hover:text-amber-400 transition-colors">
                        Name
                      </label>
                  ...
                  <div className="group">
                    ...
                    <p className="text-zinc-400 text-sm mt-2 ml-2">
                      This is what your AI will say when starting a new
                      conversation.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        <option value="friends">
                          Friends - Only my friends can see
                        </option>
                      </select>
                      <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none shadow-[0_0_15px_rgba(212,175,55,0.3)]"></div>
                    </div>
                ...
                <div className="space-y-8 animate-fade-slide-up">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="group">
                      ...
                      <p className="text-zinc-400 text-sm mt-2 ml-2">
                        The emotional style of your AI's responses.
                      </p>
                    </div>
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full bg-zinc-800/50 text-white rounded-xl p-4 pl-6 border border-zinc-700/50 focus:border-gold focus:ring-2 focus:ring-gold/30 focus:outline-none transition-all duration-300 appearance-none bg-[url('data:image/svg+xml;base64,')] bg-no-repeat bg-[right_1rem_center] bg-[length:1rem] shadow-inner">
                          <option value="casual">
                            Casual Chat - For everyday conversations
                          </option>
                          <option value="tutor">
                            Tutor Mode - For learning and educational support
                          </option>
                          <option value="creative">
                            Creative Mode - For storytelling and brainstorming
                          </option>
                          <option value="problemSolving">
                            Problem Solving - For analytical assistance
                          </option>
                          <option value="entertainment">
                            Entertainment - For fun and engaging activities
                          </option>
                          <option value="therapy">
                            Therapy - For emotional support and guidance
                          </option>
                        </select>
                        <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none shadow-[0_0_15px_rgba(212,175,55,0.3)]"></div>
                      </div>
                      <p className="text-zinc-400 text-sm mt-2 ml-2">
                        Specialized behavior for specific conversational goals.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 p-4 bg-gold/10 rounded-xl border border-gold/20">
                    ...
                    <p className="text-zinc-300 text-sm">
                      Matching the Conversation Tone with the Chat Mode creates
                      a more consistent AI personality. For example, try
                      "Enthusiastic" tone with "Entertainment" mode, or
                      "Professional" tone with "Tutor" mode.
                    </p>
                  </div>
                </div>
              )}
