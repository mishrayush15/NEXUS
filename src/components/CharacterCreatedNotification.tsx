...
const CharacterCreatedNotification: React.FC<CharacterCreatedNotificationProps> = ({ 
  ...
  return (
    <div className="fixed bottom-6 right-6 bg-green-500/90 text-white px-6 py-4 rounded-xl shadow-xl animate-fade-slide-up z-50 max-w-md flex items-start">
      ...
      <div className="flex-1">
        ...
        <p className="text-white/90">
          <span className="font-medium">{characterName}</span> has been added to your Nexus AI buddies. Go chat with them now!
        </p>
      </div>
      <button 
        onClick={onClose}
