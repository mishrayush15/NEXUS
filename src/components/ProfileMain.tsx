        ...
        <div className="mt-6 px-6 flex flex-col lg:flex-row justify-between gap-6">
          <div>
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-4">
              ...
              <button className="flex items-center justify-center gap-2 px-6 py-2 bg-gold text-zinc-900 font-medium rounded-xl w-48 hover:bg-gold/90 transition-all">
          ...
          <div className="mr-32">
            <div className="grid grid-cols-4 gap-10">
              {[
                ...
                <div
                  key={index}
                  className="bg-zinc-800 p-6 w-40 h-32 rounded-2xl text-center shadow border border-zinc-700 flex flex-col justify-center items-center">
